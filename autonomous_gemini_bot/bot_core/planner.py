...
- Результат должен быть строкой в формате JSON, содержащей два ключа: "thought" (твои размышления о задаче и плане, или прямой ответ пользователю если план пуст) и "plan" (список шагов).
