...
class Planner:
    ...
    def determine_next_action_for_goal(
        ...
        prompt_parts = [
            "Ты — ИИ-ассистент, отвечающий за определение СЛЕДУЮЩЕГО ДЕЙСТВИЯ для достижения конкретной цели. Тебе предоставлены доступные инструменты, описание цели и история уже предпринятых действий (включая их результаты) для этой цели.",
            AVAILABLE_TOOLS_DESCRIPTIONS, 
            f"\n--- Текущая Цель ---\n{goal_description}\n",
            "--- История Действий для Этой Цели ---",
            formatted_log_string,
            "\n--- Твоя Задача ---",
            "Проанализируй цель и историю действий. Определи ОДНО следующее действие (вызов инструмента) ИЛИ реши, достигнута ли цель или она недостижима.",
            "Если цель уже достигнута на основе предыдущих действий или если она не может быть достигнута, укажи это.",
